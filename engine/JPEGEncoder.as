package engine
{
   ...
   public class JPEGEncoder
   {
      ...
      private function fDCTQuant(param1:Array, param2:Array) : Array
      {
         ...
         while(_loc23_ < 8)
         {
            _loc3_ = param1[_loc22_ + 0] + param1[_loc22_ + 7];
            _loc4_ = param1[_loc22_ + 0] - param1[_loc22_ + 7];
            _loc5_ = param1[_loc22_ + 1] + param1[_loc22_ + 6];
            _loc6_ = param1[_loc22_ + 1] - param1[_loc22_ + 6];
            _loc7_ = param1[_loc22_ + 2] + param1[_loc22_ + 5];
            _loc8_ = param1[_loc22_ + 2] - param1[_loc22_ + 5];
            _loc9_ = param1[_loc22_ + 3] + param1[_loc22_ + 4];
            _loc10_ = param1[_loc22_ + 3] - param1[_loc22_ + 4];
            _loc11_ = _loc3_ + _loc9_;
            _loc12_ = _loc3_ - _loc9_;
            _loc13_ = _loc5_ + _loc7_;
            _loc14_ = _loc5_ - _loc7_;
            param1[_loc22_ + 0] = _loc11_ + _loc13_;
            param1[_loc22_ + 4] = _loc11_ - _loc13_;
            _loc15_ = (_loc14_ + _loc12_) * 0.707106781;
            param1[_loc22_ + 2] = _loc12_ + _loc15_;
            param1[_loc22_ + 6] = _loc12_ - _loc15_;
            _loc11_ = _loc10_ + _loc8_;
            _loc13_ = _loc8_ + _loc6_;
            _loc14_ = _loc6_ + _loc4_;
            _loc16_ = (_loc11_ - _loc14_) * 0.382683433;
            _loc17_ = 0.5411961 * _loc11_ + _loc16_;
            _loc18_ = 1.306562965 * _loc14_ + _loc16_;
            _loc19_ = _loc13_ * 0.707106781;
            _loc20_ = _loc4_ + _loc19_;
            _loc21_ = _loc4_ - _loc19_;
            param1[_loc22_ + 5] = _loc21_ + _loc17_;
            param1[_loc22_ + 3] = _loc21_ - _loc17_;
            param1[_loc22_ + 1] = _loc20_ + _loc18_;
            param1[_loc22_ + 7] = _loc20_ - _loc18_;
            _loc22_ += 8;
            _loc23_++;
         }
         _loc22_ = 0;
         ...
         while(_loc23_ < 8)
         {
            _loc3_ = param1[_loc22_ + 0] + param1[_loc22_ + 56];
            _loc4_ = param1[_loc22_ + 0] - param1[_loc22_ + 56];
            _loc5_ = param1[_loc22_ + 8] + param1[_loc22_ + 48];
            _loc6_ = param1[_loc22_ + 8] - param1[_loc22_ + 48];
            _loc7_ = param1[_loc22_ + 16] + param1[_loc22_ + 40];
            _loc8_ = param1[_loc22_ + 16] - param1[_loc22_ + 40];
            _loc9_ = param1[_loc22_ + 24] + param1[_loc22_ + 32];
            _loc10_ = param1[_loc22_ + 24] - param1[_loc22_ + 32];
            _loc11_ = _loc3_ + _loc9_;
            _loc12_ = _loc3_ - _loc9_;
            _loc13_ = _loc5_ + _loc7_;
            _loc14_ = _loc5_ - _loc7_;
            param1[_loc22_ + 0] = _loc11_ + _loc13_;
            param1[_loc22_ + 32] = _loc11_ - _loc13_;
            _loc15_ = (_loc14_ + _loc12_) * 0.707106781;
            param1[_loc22_ + 16] = _loc12_ + _loc15_;
            param1[_loc22_ + 48] = _loc12_ - _loc15_;
            _loc11_ = _loc10_ + _loc8_;
            _loc13_ = _loc8_ + _loc6_;
            _loc14_ = _loc6_ + _loc4_;
            _loc16_ = (_loc11_ - _loc14_) * 0.382683433;
            ...
            _loc20_ = _loc4_ + _loc19_;
            _loc21_ = _loc4_ - _loc19_;
            param1[_loc22_ + 40] = _loc21_ + _loc17_;
            param1[_loc22_ + 24] = _loc21_ - _loc17_;
            param1[_loc22_ + 8] = _loc20_ + _loc18_;
            param1[_loc22_ + 56] = _loc20_ - _loc18_;
            _loc22_++;
            _loc23_++;
         }
         _loc23_ = 0;
         while(_loc23_ < 64)
         {
            param1[_loc23_] = Math.round(param1[_loc23_] * param2[_loc23_]);
            _loc23_++;
         }
         return param1;
      }
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc8_:BitString = param5[240];
         var _loc9_:Array = this.fDCTQuant(param1,param2);
         _loc6_ = 0;
         while(_loc6_ < 64)
         {
            this.DU[this.ZigZag[_loc6_]] = _loc9_[_loc6_];
            _loc6_++;
         }
         ...
         {
            _loc12_ = _loc6_;
            while(this.DU[_loc6_] == 0 && _loc6_ <= _loc11_)
            {
               _loc6_++;
            }
            if((_loc13_ = _loc6_ - _loc12_) >= 16)
            {
               _loc14_ = 1;
               while(_loc14_ <= _loc13_ / 16)
               {
                  this.writeBits(_loc8_);
                  _loc14_++;
               }
               _loc13_ = int(_loc13_ & 15);
            }
            this.writeBits(param5[_loc13_ * 16 + this.category[32767 + this.DU[_loc6_]]]);
